...
/**
 * Test case for our LikeWorkUserRecommender
 */
@RunWith(SpringJUnit4ClassRunner.class)
@Category(IntegrationTest.class)
public class LikeWorkUserRecommenderIT extends BaseServiceIT {

	@Autowired
	private LikeWorkUserRecommender likeWorkUserRecommender;
	...
	public void testRoutingStrategy() throws Exception {
		...
		// now try our routing
		Recommendation recommendation = likeWorkUserRecommender.recommend(work, true);
	...
	public void testRoutingStrategyNoExplain() throws Exception {
		...
		// now try our routing
		Recommendation recommendation = likeWorkUserRecommender.recommend(work, false);
