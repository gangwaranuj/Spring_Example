...
public class ParsingStrategyNoAddressNumberImplTest {
	State state;
	...
	@InjectMocks ParsingStrategyNoAddressNumberImpl parsingStrategyNoAddressNumberImpl;
	...
	public void setUp() throws Exception {
		...
		when(locationDAO.findLocationsByNumberAndClientCompany(anyString(), anyLong())).thenReturn(locations);
	}
	...
	public void parseLocation_HasLocation_ReturnedTrue() throws Exception {
		...
		boolean parsed = parsingStrategyNoAddressNumberImpl.parseLocation(types, response, errors, 4L);
