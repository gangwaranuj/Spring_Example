...
public class ParsingStrategyAddressNameImplTest {
	State state;
	...
	@InjectMocks ParsingStrategyAddressNameImpl parsingStrategyAddressNameImpl;
	...
	public void parseLocation_ValidParameters_ReturnedTrue() throws Exception {
		...
		boolean parsed = parsingStrategyAddressNameImpl.parseLocation(types, response, 2L, 3);
