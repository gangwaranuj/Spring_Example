...
const id = (state = null, { type, value }) => {
	switch (type) {
	case types.UPDATE_SECONDARY_CONTACT_ID:
		return value;
	case types.CLEAR_LOCATION_FIELDS:
	case types.UPDATE_SECONDARY_CONTACT_FIRST_NAME:
	case types.UPDATE_SECONDARY_CONTACT_LAST_NAME:
	case types.UPDATE_SECONDARY_CONTACT_EMAIL:
	case types.UPDATE_SECONDARY_CONTACT_WORK_PHONE:
	case types.UPDATE_SECONDARY_CONTACT_WORK_PHONE_EXTENSION:
		return null;
	default:
		return state;
	}
...
const mobilePhone = (state = null, { type, value }) => {
	switch (type) {
	case types.UPDATE_SECONDARY_CONTACT_MOBILE_PHONE:
		return value;
	case types.CLEAR_LOCATION_FIELDS:
		return null;
	default:
