	...
	$(this).click(function(){
	  ...
	  if( $$oldIndex > -1 ){
	    ...
	    if(cell.hasClass('check')) {
		    cell.removeClass('check').removeClass('checkwht').removeClass('checkblk');
	    }
	  }
	  // Keep index
	  $$oldIndex = i;
      ...
      //_tmp = $$oldIndex;
      $$oldIndex = -1;
      // COMMENTED OUT BY CHRIS LEWIS. It was causing issues with the Ajax post of the color setting.
