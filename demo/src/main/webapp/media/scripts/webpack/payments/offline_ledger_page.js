...
import CustomHeaderTemplate from './templates/offline-custom-header.hbs';
...
export default () => {
	...
	function createLedgerDatatable(tableId) {
		return $(`#${tableId}`).dataTable({
			bPaginate : (tableId === 'offline_activity_list'),
	...
	datatableObj = createLedgerDatatable('offline_activity_list');
