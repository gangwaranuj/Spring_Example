...
<wm:admin pagetitle="Tax" webpackScript="admin">
	...
	<div class="content">
		...
		<h4>1099-MISC Data Report</h4>

		<div id="earnings_detail">
			<div class="toolbar">
		...
		<hr>
		<h5>Earnings Detail Report Data</h5>

		<div id="earnings_detail_published">
			<table class="table table-striped">
				<thead>
				<tr>
					<td>Tax Year</td>
	...
	<script type="text/x-jquery-tmpl" id="earnings_detail_report_row_template">
		<tr>
			<td>
				{{if status.issued }}
			...
			<td>
				...
				{{else}}
				<a class="download" href="/admin/accounting/earnings_detail/download/\${id}">Download</a> / <a class="delete" data-id="\${id}" href="#">Delete</a>
				{{/if}}
			</td>
		</tr>
	</script>

	<script type="text/x-jquery-tmpl" id="earnings_detail_report_published_row_template">
		<tr>
			<td>\${taxYear}</td>
			<td>\${createdOn}</td>
			<td><a class="download" href="/admin/accounting/earnings_detail/download/\${id}">Download</a>
		</tr>
	</script>
