...
<wm:admin pagetitle="1099" webpackScript="admin">
	<script>
		var config = {
			mode: 'taxIssuanceForm',
	...
	<div class="content">
		...
		<h5>1099-MISC Data</h5>

		<div id="form1099_published">
			<table class="table table-striped">
				<thead>
				<tr>
					<td>Tax Year</td>
	...
	<script type="text/x-jquery-tmpl" id="tax_form_row_template">
		<tr>
			<td>
				{{if status.issued }}
			...
			<td>
				...
				{{else}}
					<a class="download" href="/admin/accounting/form_1099/download/\${id}">Download</a> / <a class="delete" data-id="\${id}" href="#">Delete</a>
				{{/if}}
			</td>
		</tr>
	</script>

	<script type="text/x-jquery-tmpl" id="tax_form_published_row_template">
		<tr>
			<td>\${taxYear}</td>
			<td>\${createdOn}</td>
			<td><a class="download" href="/admin/accounting/form_1099/download/\${id}">Download</a>
		</tr>
	</script>
