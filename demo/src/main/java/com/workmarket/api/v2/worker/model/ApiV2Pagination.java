    ...
    public static class ApiPaginationBuilder {
        ...
        private Map<String, String> generateLinks(final HttpServletRequest request) {
            ...
            if (page < totalPageCount) {
                ...
                links.put
                    (
                        ApiV2Pagination.NEXT_PAGE_LINK_KEY,
                        link(request,page + 1)
                    );
            }
            ...
            if (page > 1) {
                ...
                links.put
                    (
                        ApiV2Pagination.PREVIOUS_PAGE_LINK_KEY,
            ...
            links.put
                (
                    ApiV2Pagination.FIRST_PAGE_LINK_KEY,
                    link(request,1L)
                );
            ...
            if (totalPageCount != null && totalPageCount > 0) {
                ...
                links.put
                    (
                        ApiV2Pagination.LAST_PAGE_LINK_KEY,
                        link(request,totalPageCount)
                    );
            }
        ...
        private String link(final HttpServletRequest request,
                            final Long page) {
