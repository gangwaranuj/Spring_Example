 ...
 */
public class WorkerFiltersCriteriaBuilder extends BaseWorkerSearchCriteriaBuilder {
	 ...
	 */
	public WorkerFiltersCriteriaBuilder(final WorkService workService,
	...
	protected void createCustomCriteria() {
		findWorkerCriteriaBuilder.setExcludeHighlights(Boolean.TRUE);
	}
}
