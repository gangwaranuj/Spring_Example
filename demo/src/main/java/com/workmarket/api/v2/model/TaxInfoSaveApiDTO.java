...
@ApiModel(value = "TaxInfoSave")
@JsonFilter(ApiBaseHttpMessageConverter.FILTER_API_PROJECTIONS)
@JsonDeserialize(builder = TaxInfoSaveApiDTO.Builder.class)
public class TaxInfoSaveApiDTO {
  ...
  public TaxInfoSaveApiDTO(final Builder builder) {
  ...
  public static class Builder implements AbstractBuilder<TaxInfoSaveApiDTO> {
    ...
    @Override
    public TaxInfoSaveApiDTO build() {
      return new TaxInfoSaveApiDTO(this);
    }
  }
}