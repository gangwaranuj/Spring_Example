...
@ApiModel(value = "DeclinedResource")
@JsonDeserialize(builder = ApiDeclinedResourceDTO.Builder.class)
public class ApiDeclinedResourceDTO {
	...
	private ApiDeclinedResourceDTO(Builder builder) {
		id = builder.id;
	...
	public static final class Builder {
		...
		public Builder(ApiDeclinedResourceDTO copy) {
			this.id = copy.id;
		...
		public ApiDeclinedResourceDTO build() {
			return new ApiDeclinedResourceDTO(this);
		}
	}
}
