...
import com.workmarket.service.validation.validators.TaxInfoDTOValidator;
...
@Service("taxInfoValidationService")
public class TaxInfoValidationServiceImpl extends AbstractValidationService {

	@Autowired private TaxInfoDTOValidator validator;
