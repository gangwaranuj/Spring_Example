...
@Component
public class HibernateTrialWrapperWithTransaction implements CallableObservableWrapper {
	...
	@Autowired
	public HibernateTrialWrapperWithTransaction(
			@Qualifier("sessionFactory") final SessionFactory factory,
