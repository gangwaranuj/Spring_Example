...
@AuditChanges
public class CompanyPropertyChangeLog extends CompanyChangeLog {
	...
	public CompanyPropertyChangeLog() {}

	public CompanyPropertyChangeLog(Company company, User actor, User masqueradeActor, String propertyName, String oldValue, String newValue) {
