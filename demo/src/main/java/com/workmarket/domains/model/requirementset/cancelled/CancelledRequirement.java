...
@Entity
@AuditChanges
@Table(name = "cancelled_requirement")
public class CancelledRequirement extends AbstractRequirement {
	public static final String DEFAULT_NAME = "Cancelled Requirement";
	public static final String NAME_TEMPLATE = "%s within last 6 months";
	public static final String HUMAN_NAME = "Maximum Cancelled Assignments";
	public static final String[] FILTERS = {};

	private int maximumAllowed; // max ceiling of cancelleds
