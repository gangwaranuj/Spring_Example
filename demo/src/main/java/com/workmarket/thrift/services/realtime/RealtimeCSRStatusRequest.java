...
public class RealtimeCSRStatusRequest implements Serializable {
	...
	public RealtimeCSRStatusRequest() {
	}

	public RealtimeCSRStatusRequest(RealtimePagination paginationRequest) {
		this();
	...
	public RealtimeCSRStatusRequest setPaginationRequest(RealtimePagination paginationRequest) {
		this.paginationRequest = paginationRequest;
		return this;
	}
	...
	public RealtimeCSRStatusRequest setInternalOwnerFilter(List<String> internalOwnerFilter) {
	...
	public RealtimeCSRStatusRequest setFilters(RealtimeFilter filters) {
	...
	public boolean equals(Object that) {
		if (that == null)
			return false;
		if (that instanceof RealtimeCSRStatusRequest)
			return this.equals((RealtimeCSRStatusRequest) that);
		return false;
	}

	private boolean equals(RealtimeCSRStatusRequest that) {
		if (that == null)
			return false;
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("RealtimeCSRStatusRequest(");
		boolean first = true;
