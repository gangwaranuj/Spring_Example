...
public class ItemRemoveRequest implements Serializable {
	...
	public ItemRemoveRequest(long userId, long assessmentId, Item item) {
		this();
		this.userId = userId;
	...
	public ItemRemoveRequest setUserId(long userId) {
		this.userId = userId;
		return this;
	}
	...
	public ItemRemoveRequest setAssessmentId(long assessmentId) {
		this.assessmentId = assessmentId;
		return this;
	}
	...
	public ItemRemoveRequest setItem(Item item) {
		this.item = item;
		return this;
	}
	...
	public boolean equals(Object that) {
		if (that == null)
			return false;
		if (that instanceof ItemRemoveRequest)
			return this.equals((ItemRemoveRequest) that);
		return false;
	}

	private boolean equals(ItemRemoveRequest that) {
		if (that == null)
			return false;
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("ItemRemoveRequest(");
		boolean first = true;
