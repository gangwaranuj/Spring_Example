...
public class ForumCommentAddedPostForCreatorNotificationTemplateWithJavaObjects extends NotificationTemplate {
    ...
    protected ForumCommentAddedPostForCreatorNotificationTemplateWithJavaObjects(final Long toId, final ForumPost comment, final ForumPost parent, final String creatorFullName) {
