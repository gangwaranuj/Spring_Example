...
public class FundsDepositedNotificationTemplate extends NotificationTemplate {
	...
	public FundsDepositedNotificationTemplate(Long toId, RegisterTransaction transaction, Integer invoicesDueCount, BigDecimal invoicesDueTotal, Calendar invoicesDueDate) {
