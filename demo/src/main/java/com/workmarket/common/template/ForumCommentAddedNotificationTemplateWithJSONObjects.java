...
public class ForumCommentAddedNotificationTemplateWithJSONObjects extends NotificationTemplate {
    ...
    protected ForumCommentAddedNotificationTemplateWithJSONObjects(final Long toId, final Map<String, Object> comment, final Map<String, Object> parent, final String creatorFullName) {
