...
public class FundsWithdrawnFromGCCNotificationTemplate  extends NotificationTemplate {
	private static final long serialVersionUID = 7712947857950272832L;
	private RegisterTransaction transaction;

	public FundsWithdrawnFromGCCNotificationTemplate(Long toId, RegisterTransaction transaction) {
