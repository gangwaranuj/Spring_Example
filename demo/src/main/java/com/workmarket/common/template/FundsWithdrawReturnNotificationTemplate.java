...
public class FundsWithdrawReturnNotificationTemplate extends NotificationTemplate {
	private static final long serialVersionUID = 4724355431525970302L;

	private RegisterTransaction transaction;

	public FundsWithdrawReturnNotificationTemplate(Long toId, RegisterTransaction transaction) {
