...
<wm:app pagetitle="Realtime" bodyclass="realtime" breadcrumbSection="Work" breadcrumbSectionURI="/assignments" breadcrumbPage="Realtime" fluid="true" webpackScript="realtime">
	...
	<form id="realtime-counts" action="/realtime/counts" method="POST"></form>

	<form id="realtime-filters" action="/realtime/update" method="POST">
		<div class="well">
			<div class="row">
				<div class="span5">
				...
				<div class="span4">
					<div class="control-group">
						...
						<div class="controls">
							<select name="filters[internal_owners][]" id="internal_owners" class="wm-select" multiple="multiple">
					...
					<div class="control-group">
						...
						<div class="controls">
							<select name="filters[projects][]" id="projects" class="wm-select" multiple="multiple">
				...
				<div class="span4">
					<div class="control-group">
						...
						<div class="controls">
							<select name="filters[clients][]" id="clients" class="wm-select" multiple="multiple">
			...
			<div class="collapsed-content">
				{{each(i, resource) resources}}
					{{if i < 8}}
						...
						{{/if}}
					{{else i == 8}}
						<em>\${resource_count - 8} more workers</em>
					{{/if}}
				{{/each}}
			</div>
			<div class="expanded-content">
	...
	<script id="tmpl-noresults_row" type="text/x-jquery-tmpl">
		<td colspan="7">There are currently no assignments.</td>
	</script>
