<h2>Add Contact to Location</h2>
<p><em>https://www.workmarket.com/api/v1/<strong>addressbook/locations/contacts/add</strong></em></p>

<p>Create a new contact and add to an existing location.</p>
...
<table>
	<tbody>
		<tr>
			...
			<td></td>
			<td><span class="required"></span> The location identifier</td>
		</tr>
		<tr>
...
<table>
	<tbody>
		<tr>
			<td><code>emails[<em>&lt;N&gt;</em>]</code></td>
