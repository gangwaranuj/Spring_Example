...
<wm:admin pagetitle="Tools" webpackScript="admin">
		...
		<div class="dn">
			<div id="modify_tag_modal">
				<div class="control-group">
					<p>Selecting an existing name from the suggestions will result in the specialty being merged into the selected specialty.</p>
