...
<wm:app pagetitle="Ledger" bodyclass="payment page-payments" webpackScript="payments">
	...
	<div class="inner-container" id="ledger_container">
		...
		<div id="pending_activity" class="table">
			<div class="table--header">
				<h1 class="table--title">Pending Transactions</h1>
			</div>
			<table id="pending_activity_list">
				<thead>
					<tr>
						<th width="5%">Date</th>
						<th width="15%">Type</th>
						<th>Description</th>
						<th width="10%" class="tar">Debit</th>
						<th width="10%" class="tar">Credit</th>
					</tr>
				</thead>
				<tbody></tbody>
			</table>
		...
		<div class="table">
			<div class="table--header">
				...
				<form action="/payments/ledger" id="filters" class="pull-right">
					From
			...
			<table id="activity_list">
				<thead>
					<tr>
						...
						<th width="10%" class="tar">Debit</th>
						<th width="10%" class="tar">Credit</th>
						<th width="10%" class="tar">Balance</th>
					</tr>
				</thead>
				<tbody></tbody>
			</table>
