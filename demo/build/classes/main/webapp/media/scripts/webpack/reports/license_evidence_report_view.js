...
export default Backbone.View.extend({
	...
	applyGroupFilter: function () {
		...
		$.ajax({
			dataType: 'json',
			type: 'GET',
			url: '/reports/evidence/license_report.json?groupId=' + groupId,
			success: function (data) {
				...
				$('#evidence_report').dataTable({
					...
					'aoColumnDefs': [
						...
						{'sTitle':'State','sType':'string','aTargets':[2]},
						{'sTitle':'License','sType':'string','aTargets':[3]},
						{'sTitle':'License Number','sType':'string','aTargets':[4]},
