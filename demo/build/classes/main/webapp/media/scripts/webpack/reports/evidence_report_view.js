...
export default Backbone.View.extend({
	...
	applyGroupFilter: function () {
		...
		$.ajax({
			dataType: 'json',
			type: 'GET',
			url: '/reports/evidence/report_data.json?groupId=' + groupId + '&screeningType=' + this.options.screeningType,
			success: function (data) {
				...
				$('#evidence_report').dataTable({
					...
					'aoColumnDefs': [
						...
						{'sTitle':'Certificate Date','sType':'date','aTargets':[2]},
						{'sTitle':'Actions','sType':'html','aTargets':[3]}
					],
