...
export default AbstractView.extend({
	...
	render: function() {
		...
		this.$el.find('[data-placeholder="requirable"]').html(this.selectTemplate({
			label: 'Select the talent pool that you require your worker to be a member of',
			lowerLabel: 'Select the talent pool that you require your worker to be a member of'.toLowerCase(),
